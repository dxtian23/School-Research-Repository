...
<head>
	...
	<style type="text/css">
		...
		.navbar-link {
  		...
  		.navbar-link:focus,
  		.navbar-link:hover {
    	color: red; /* Color for active nav link */
  		}
  		#New {	
  			margin-left: 10px;
  			margin-right: 10px;
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="navbar-link active" aria-current="page" href="research_res.php" id="Rrecord">Research Records</a>
                            </li>
                             <li class="nav-item">
                                <a class="navbar-link" href="users.php" id="Rrecord">Edit Credentials</a>
                            </li>
                        </ul>
                        <form class="d-flex">
